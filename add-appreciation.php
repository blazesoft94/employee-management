...
if(isset($_POST['submit_appreciation'])) {
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST' AND isset($_FILES['image'])) {
				if( $_FILES['image']['size'] < $max_file_size ){
					...
					if (in_array($ext, $valid_exts)) {
						...
						$insert_details = mysql_query("INSERT INTO appreciation (`app_img`,`app_name`,`app_designation`,`app_details`,`display_date`,`created_date`,`modify_date`) VALUES ('".$path."','".$title."','".$designation."','".$details."','".$display_date."','".$created_date."','')");
						if($insert_details) {
							// success added
...
<head>
  <title><?php echo $settings['title']; ?> - Appreciation of the day</title>
  ...
  <div class="content">
    ...
    <div class="content-container">
      ...
      <div class="content-header">
        <h2 class="content-header-title">Appreciation</h2>
        <ol class="breadcrumb">
          <li><a href="<?php echo $conf_path;?>">Home</a></li>
          <li class="active">Appreciation of the day</li>
        </ol>
      </div> <!-- /.content-header -->
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-header">
	              <h3><i class="fa fa-tasks"></i>    Add Appreciation</h3>
	            </div>
		...
		echo $msg; 
            ...
            <div class="col-sm-12">
             <div class="form-group">
                  ...
                  <textarea class="form-control parsley-validated"  rows="6" cols="10" id="details" name="details"></textarea>
                  </div>
                </div>
             
                 <div class="col-sm-6">
                 <input class="btn  btn-secondary"  type="submit" name="submit_appreciation" id="submit_appreciation" value="Submit"/>
                </div>
