...
if(isset($_POST['submit_thought'])) {
	...
	$select = mysql_query("SELECT * FROM thoughts WHERE display_date='".$display_date."'");
	$created_date = date('Y-m-d');
	
	if(empty($t_title) || empty($t_details) || empty($_POST['display_date']) || empty($_FILES['image'])) {
		...
		if(mysql_num_rows($select) == 1) {
			// already added that dates
			$msg = '<div class="alert alert-warning">
						<a aria-hidden="true" href="#" data-dismiss="alert" class="close">×</a>
						<i class="fa fa-envelope"></i>&nbsp; Display Date already in the list... please add new one..
					</div>';
		} else {
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST' AND isset($_FILES['image'])) {
				if( $_FILES['image']['size'] < $max_file_size ){
					...
					if (in_array($ext, $valid_exts)) {
						...
						$insert_details = mysql_query("INSERT INTO thoughts (`t_title`,`t_details`,`t_img`,`display_date`,`created_date`,`modify_date`) VALUES ('".$t_title."','".$t_details."','".$path."','".$display_date."','".$created_date."','')");
						if($insert_details) {
							// success added
...
<head>
  <title><?php echo $settings['title']; ?> - Add Thought of the day</title>
  ...
  <div class="content">
    ...
    <div class="content-container">
      ...
      <div class="content-header">
        <h2 class="content-header-title">Add Thought of the day</h2>
        <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-header">
	              <h3><i class="fa fa-tasks"></i>    Add Thoughts date</h3>
	            </div>
		...
		echo $msg; 
            ...
            <div class="col-sm-8">
              <div class="form-group">
                   <label for="t_title">Thoughts Title: <em class="red-col"> *</em></label>
                 	<input type="text" name="t_title" id="t_title" class="form-control" data-required="true">
                </div>
              <div class="form-group">
                  <label for="display_date">Display Date: <em class="red-col"> *</em></label>
                  <div class="input-group date ui-datepicker">
                      <input id="display_date" name="display_date" class="form-control" type="text" data-required="true">
            ...
            <div class="col-sm-12">
             <div class="form-group">
                  ...
                  <textarea class="form-control parsley-validated"  rows="2" cols="10" id="t_details" name="t_details" data-minlength="5" data-required="true"></textarea>
                  </div>
                </div>
             
                 <div class="col-sm-6">
                 <input class="btn  btn-secondary"  type="submit" name="submit_thought" id="submit_thought" value="Submit"/>
                </div>
