...
if(isset($_GET['eid'])) {
	...
	$select_l = mysql_query("SELECT * FROM 	announcement WHERE ann_id='".$eid."'");
...
if(isset($_POST['submit_announcement'])) {
	 ...
	 if(empty($title) || empty($display_from) || empty($display_to) || empty($details)) {
		...
		$update_details = mysql_query("UPDATE announcement  SET `display_from`='".$display_from."',`display_to`='".$display_to."',`title`='".$title."',`content`='".$details."',`modify_date`='".$mod_date."' WHERE 	ann_id='".$eid."'");
		if($update_details) {
			$msg = '<div class="alert alert-success">
						<a aria-hidden="true" href="#" data-dismiss="alert" class="close">×</a>
						<i class="fa fa-envelope"></i>&nbsp; Announcement Updated successfully
					</div>';
		} else {
			$msg = '<div class="alert alert-warning">
						<a aria-hidden="true" href="#" data-dismiss="alert" class="close">×</a>
...
<head>
  <title><?php echo $settings['title']; ?> - Edit Announcement</title>
    ...
    <div class="content-container">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-header">
	              <h3><i class="fa fa-tasks"></i>    Edit Announcement</h3>
	            </div>
		...
		echo $msg; 
            ...
            <?php
$select_list = mysql_query("SELECT * FROM 	announcement WHERE 	ann_id='".$eid."'");
...
$row = mysql_fetch_array($select_list);?>    
            ...
            <div class="col-sm-4">
              <div class="form-group">
                   <label for="t_title">Name of the Announcement: <em class="red-col"> *</em></label>
                 	<input type="text" name="title" id="title" value="<?php echo $row['title']; ?>" class="form-control" data-required="true">
                </div>
             </div>
             <div class="col-sm-4">
              <div class="form-group">
                  ...
                  <div class="input-group date ui-datepicker">
                      <input id="display_from" name="display_from" value="<?php echo date('m/d/Y', strtotime($row['display_from'])); ?>" class="form-control" type="text" data-required="true">
           ...
           <div class="col-sm-4">
              <div class="form-group">
                  ...
                  <div class="input-group date ui-datepicker">
                      <input id="display_to" name="display_to" value="<?php echo date('m/d/Y', strtotime($row['display_to'])); ?>" class="form-control" type="text" data-required="true">
                      <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  </div>
                </div>
             </div>
            ...
            <div class="col-sm-12">
             <div class="form-group">
                  ...
                  <textarea class="form-control parsley-validated"  data-required="true"  rows="6" cols="10" id="content" name="content"><?php echo $row['content']; ?></textarea>
                  </div>
                </div>
...
<!-- selcted id wrong -->
 <div class="alert alert-info">
        There is No <strong>Announcement</strong> to be editable list
      </div>
<?php } ?>           
