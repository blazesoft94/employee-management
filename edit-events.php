...
if(isset($_GET['eid'])) {
	...
	$select_l = mysql_query("SELECT * FROM 	events WHERE event_id='".$eid."'");
...
if(isset($_POST['edit_event'])) {
	 ...
	 if(empty($title)) {
		...
		$update = mysql_query("UPDATE events  SET `event_name`='".$title."', `event_description`='".$description."',`event_date`='".$display_date."', `modify_date`='".$mod_date."' WHERE event_id ='".$eid."'");
		if($update) {
			$msg = '<div class="alert alert-success">
						<a aria-hidden="true" href="#" data-dismiss="alert" class="close">×</a>
						<i class="fa fa-envelope"></i>&nbsp; Events Updated Successfully
					</div>';
		} else {
			echo mysql_error();
		}
...
<head>
  <title><?php echo $settings['title']; ?> - Edit Events</title>
  ...
  <link rel="stylesheet" href="js/plugins/fileupload/bootstrap-fileupload.css">
   <link rel="stylesheet" href="js/plugins/multiupload/css/uploadfilemulti.css">
...
<div class="container">
  ...
  <div class="content">
    ...
    <div class="content-container">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-header">
	              <h3><i class="fa fa-tasks"></i>    Edit Events</h3>
	            </div>
      ...
      <?php
$select_list = mysql_query("SELECT * FROM events WHERE event_id='".$eid."'");
...
$row = mysql_fetch_array($select_list);?>          
            ...
            <div class="col-sm-6">
              <div class="form-group">
                   <label for="t_title">Name of the Events: <em class="red-col"> *</em></label>
                 	<input type="text" name="title" id="title" class="form-control" value="<?php echo $row['event_name'];?>" data-required="true">
                </div>
           </div>
             <div class="col-sm-6">
                 <div class="form-group">
                  ...
                  <div class="input-group date ui-datepicker">
                      <input id="display_date" name="display_date" value="<?php echo date('m/d/Y', strtotime($row['event_date']));?>" class="form-control" type="text"/>
            ...
            <div class="col-sm-8">
                 ...
                 <div class="form-group">
                   ...
                   <textarea name="description" class="form-control"><?php echo $row['event_description'];?></textarea>
                </div>
                 ...
                 <div class="col-sm-6">
                 <input class="btn  btn-secondary"  type="submit" name="edit_event" id="add_event" value="Submit"/>
                </div>
...
<?php include_once("includes/footer.php"); ?>
  ...
  <script src="js/libs/jquery-1.10.1.min.js"></script>
   <script src="js/plugins/multiupload/jquery.fileuploadmulti.min.js"></script>
  <script>
