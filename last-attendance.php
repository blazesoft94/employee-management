...
<head>
  <title><?php echo $settings['title']; ?> - Last Attendance</title>
    ...
    <div class="content-container">
      ...
      <div class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Last Attendance</li>
        </ol>
      </div> <!-- /.content-header -->
...
if(isset($_POST['l_signout']))
{
	// SUBMIT BUTTON PRESSED
	$l_signout_remarks = mysql_real_escape_string($_POST['l_signout_remarks']);
	...
	$update_info = mysql_query("UPDATE attendance SET signout_time ='".$markout_time."', signout_late_note = '".$l_signout_remarks."', working_hours = '".$working_hours_time."', status ='0', punchout_type='Custom Markout' where username = '".$_SESSION['username']."' and aid = '".$attendance_id."' and signin_date='".$attendance_date."'");
	if($update_info) {
  ...
  <div class="wall">
 		...
 		<form method="post" action="#"  data-validate="parsley" class="form parsley-form">
            ...
            <div class="form-group col-sm-12">
			 <textarea class="form-control " rows="3" cols="10" name="l_signout_remarks"  placeholder="Enter your Remarks" data-required="true" ></textarea>
            </div>
            
		 	<div class="form-group col-sm-12">
           		<button class="btn btn-success" type="submit" name="l_signout" >
           			<i class="fa fa-sign-in"></i> Custom Markout
           		</button>
        	</div>
            <div class="form-group col-sm-12">
