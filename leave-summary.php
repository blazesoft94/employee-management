...
/* 0 - pending
   ...
   <?php
      $leave =  mysql_query("SELECT * FROM leave_management WHERE username='".$_SESSION['username']."'");
...
?>
             ...
             <div class="table-responsive">
              ...
              >
                  <thead>
                    <tr>
                      <th  data-direction="asc" data-sortable="true">From date</th>
                      ...
                      <th data-sortable="true">Approved/Cancel</th>
