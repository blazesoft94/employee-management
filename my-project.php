...
else
{
	...
	if(($_SESSION['role'] == 'admin') || ($_SESSION['role'] == 'manager') || ($_SESSION['role'] == 'Supervisor')  || ($permission == "access")) {
...
<head>
  <title><?php echo $settings['title']; ?> - My Projects </title>
  ...
  <div class="content">
    ...
    <div class="content-container">
      <div class="content-header">
        <h2 class="content-header-title">My Discipline Projects</h2>
        <ol class="breadcrumb">
...
/* 0 - pending
   ...
   $username = $_SESSION["username"];
      $leave =  mysql_query("SELECT di_id, u.username as empUsername, di_date,di_location,di_violation,di_hour,di_minute,di_meridian,a.fname as appointedFname, di_status FROM disciplines inner join users u on di_emp_idu = u.idu left join users a on di_appointed_to = a.idu where a.username = '$username' ORDER BY di_date DESC");
                  ...
                  <thead>
                    <tr>
                     <th data-filterable="true" data-direction="asc" data-sortable="true" >#</th>
                      ...
                      <th data-filterable="true" data-sortable="true">View and Edit Status</th>
				  ...
				  $count = 1;
				   while($row = mysql_fetch_array($leave)) { 
                  	...
                  	<tr>
                        ...
                        <td >
                        <button class="btn btn-facebook ui-popover" data-toggle="tooltip" data-placement="left" data-trigger="hover" data-content="View Discipline Details and change status" title="" onclick="location.href='view-discipline.php?view=TRUE&di_id=<?php echo $row["di_id"] ?>'" type="button" data-original-title="admin"><i class="fa fa-edit"></i></button>
                        </td>
